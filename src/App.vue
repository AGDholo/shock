                  ...
                  <div class="grey--text text--darken-1">
                    ...
                    <div class="my-5">
                      <p class="font-weight-regular">
                        Showcase your startup with the front and landing pages
                        it deserves. With a lot of care we developed some of the
                        best presentational pages you can get.
                      </p>
                    </div>
                  </div>
              ...
              <v-col cols="12" md="5">
                <div>
                  ...
                  <div class="grey--text text--darken-1">
                    ...
                    <div class="my-5">
                      <p class="font-weight-regular">
                        Start your development with a Premium Dashboard built
                        with over 200 individual components, giving you the
                        freedom of choosing and combining.
                      </p>
                    </div>
                  </div>
            ...
            <v-card-text class="subtitle-1">
              ...
              <div class="my-6">
                ...
                <span class="secondary--text">
                  App running at: <br />
                  - Local: http://localhost:8080/</span
                >
              </div>
            </v-card-text>
          </v-card>
